                              ...
                              [
                                ...
                                Row(
                                  ...
                                  [
                                    ...
                                    Text("Category",  overflow: TextOverflow.ellipsis, style: TextStyle(fontSize: size.width * 0.05),),
                                    //
                                  ],
                                ),
                                ...
                                Row(
                                  ...
                                  [
                                    ...
                                    Text("3", style: TextStyle(fontSize: size.width * 0.05),),
                                    SizedBox(
                                      width: size.width * 0.1,
                                    ),
                                    Text("Motorbike", style: TextStyle(fontSize: size.width * 0.05),),
                                  ],
                                ),
                              ],
                            ),
